...
namespace Cookbook.Controllers
{
    public class RecipesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Cuisine,Rating,Cooktime,Description,Ingredients,Directions")] Recipe recipe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Cuisine,Rating,Cooktime,Description,Ingredients,Directions")] Recipe recipe)
        {
            if (id != recipe.Id)
            {
                return NotFound();
